...
TARGET_BOOTLOADER_BOARD_NAME := Aquaris_E4

# Platform
TARGET_BOARD_PLATFORM := MTK6582M
...
# Kernel
TARGET_PREBUILT_KERNEL := device/bq/puar/kernel
BOARD_KERNEL_CMDLINE :=
BOARD_CUSTOM_BOOTIMG_MK := device/bq/puar/mkbootimg.mk
...
# TWRP-Specific
TARGET_RECOVERY_FSTAB := device/bq/puar/recovery/etc/twrp.fstab
